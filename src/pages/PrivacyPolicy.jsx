        ...
        <>
            ...
            <div className="flex flex-col mx-auto p-2 max-w-[750px]">
                ...
                <div className="flex flex-col p-3 my-2 bg-orange-200">
                    ...
                    <a href='#sec1'>
                        <span className="font-bold my-5 mr-2 cursor-pointer">1. Information We Collect</span>
                    </a>

                    <a href='#sec2'>
                        <span className="font-bold my-5 mr-2 cursor-pointer">2. How We Use the Information We Collect</span>
                    </a>

                    <a href='#sec3'>
                        <span className="font-bold my-5 mr-2 cursor-pointer">3. How We Share the Personal Information We Collect</span>
                    </a>

                    <a href='#sec4'>
                        <span className="font-bold my-5 mr-2 cursor-pointer">4. Children&apos;s Privacy Notice</span>
                    </a>

                    <a href='#sec5'>
                        <span className="font-bold my-5 mr-2 cursor-pointer">5. Your Choices</span>
                    </a>

                    <a href='#sec6'>
                        <span className="font-bold my-5 mr-2 cursor-pointer">6. Access to and Correction and Deletion of Personal Information</span>
                    </a>

                    <a href='#sec7'>
                        <span className="font-bold my-5 mr-2 cursor-pointer">7. Cookies and Similar Technologies</span>
                    </a>

                    <a href='#sec8'>
                        <span className="font-bold my-5 mr-2 cursor-pointer">8. Targeted Advertising</span>
                    </a>

                    <a href='#sec9'>
                        <span className="font-bold my-5 mr-2 cursor-pointer">9. Links to Other Websites and Social Media</span>
                    </a>

                    <a href='#sec10'>
                        <span className="font-bold my-5 mr-2 cursor-pointer">10. Information Security</span>
                    </a>

                    <a href='#sec11'>
                        <span className="font-bold my-5 mr-2 cursor-pointer">11. Retention of Personal Information</span>
                    </a>

                    <a href='#sec12'>
                        <span className="font-bold my-5 mr-2 cursor-pointer">12. Changes to our Privacy Statement</span>
                    </a>

                    <a href='#sec13'>
                        <span className="font-bold my-5 mr-2 cursor-pointer block">13. How to Contact Us</span>
                    </a>
                ...
                <span id="sec1" className="font-bold mb-5 mr-2">1. Information We Collect</span>

                <p className="mb-6 break-words">
                    We may collect personal information about you when you visit one of our restaurants, use Buffalo Burger Web sites (“Sites”), or use our web or mobile device applications (“Mobile Apps”). We refer to our Sites and Apps collectively as “Online Services”.
                </p>
                ...
                <p className="mb-6 break-words">
                    Personal details such as name, postal address, email address, phone number, date of birth and other contact information when you provide that information to us, such as if you register with our Online Services or enter a Buffalo Burger contest, competition, prize draw, or sweepstakes.
                </p>

                <p className="mb-6 break-words">
                    Account information, such as username, password, and other identifiers or credentials used to access our Online Services or to acquire Buffalo Burger products and services.
                </p>

                <p className="mb-6 break-words">
                    Other personal information you choose to provide when you interact with Buffalo Burger.
                </p>
                ...
                <p className="mb-6 break-words">
                    We may combine personal information that we collect with information we receive from other sources, information about your prior transactions with Buffalo Burger and information that is automatically collected.
                </p>

                {/* Sec 2 */}
                <span id="sec2" className="font-bold mb-5 mr-2"> 2. How We Use the Information We Collect</span>

                <p className="mb-6 break-words">
                    Buffalo Burger may use the personal information we collect to:
                </p>
                ...
                <p className="mb-6 break-words">
                    If you give us permission, communicate with you about products and services of Buffalo Burger or our business partners that we believe may interest you;
                </p>
                ...
                <p className="mb-6 break-words">
                    Send communications to you about your orders, purchases or accounts with Buffalo Burger;
                </p>
                ...
                <p className="mb-6 break-words">
                    Enable you to post on our blogs and interact with Buffalo Burger through social media;
                </p>
                ...
                {/*Sec 3 */}
                <span id="sec3" className="font-bold mb-5 mr-2">3. How We Share the Personal Information We Collect</span>

                <p className="mb-6 break-words">
                    Buffalo Burger does not sell or otherwise share personal information about you, except as described in this Privacy Statement.
                </p>

                <p className="mb-6 break-words">
                    Buffalo Burger may share personal information within the Saal Invest company. Saal Invest includes Buffalo Burger, El Deb Crepe, Amazonya, Roma Pizza to Go, its affiliates, subsidiaries, and franchisees. Members of the Saal Invest team that receive this information from Buffalo Burger are not authorized to use or disclose the information except as provided in this Privacy Statement.
                </p>

                <p className="mb-6 break-words">
                    Buffalo Burger may share personal information with vendors that provide services to Buffalo Burger, such as fulfilling orders, providing data processing and other information technology services, administering promotions, contests, prize draws and sweepstakes, conducting research and performing analytics, and personalizing individual Buffalo Burger experiences. We do not authorize these vendors to use the personal information or to disclose it for any purpose other than to perform services on our behalf.
                </p>

                <p className="mb-6 break-words">
                    Circumstances may arise where, whether for strategic or other business reasons, Buffalo Burger decides to sell or transfer all or a portion of our business. We may transfer information we have collected and stored, including personal information, to the party or parties involved in the transaction as part of that transaction.
                </p>

                <p className="mb-6 break-words">
                    Buffalo Burger reserves the right to use or disclose personal information as needed to satisfy any law, regulation or legal request, to protect the integrity of our Online Services and in-restaurant technologies, to bring or defend against legal claims, to protect the rights, interests, safety and security of Saal Invest, Saal Invest employees or franchisees, or members of the public, or in connection with the investigation of fraud, illegal activity or violation of Buffalo Burger’s policy.
                </p>

                {/* Sec 4 */}
                <span id="sec4" className="font-bold mb-5 mr-2">4. Children&apos;s Privacy Notice</span>

                <p className="mb-6 break-words">
                    Buffalo Burger understands the importance of privacy of users of our Online Services. We are especially committed to protecting the privacy of children who visit or use our Online Services. This Children&apos;s Privacy Notice is designed to answer your questions regarding our practices with respect to personal information we collect through our Online Services from children under the age of [13].
                </p>

                <p className="mb-6 break-words">
                    A. What Personal Information Does Buffalo Burger Collect?
                </p>

                <p className="mb-6 break-words">
                    On occasion, we may collect personal information, such as an email address from children as part of an activity. For example:
                </p>
                ...
                <p className="mb-6 break-words">
                    Buffalo Burger will not condition a child&apos;s participation in any online activity on the child&apos;s disclosure of more personal information than is reasonably necessary to participate in that activity.
                </p>

                <p className="mb-6 break-words">
                    B. How Does Buffalo Burger Use the Personal Information It Collects?
                </p>
                ...
                <p className="mb-6 break-words">
                    C. How Does Buffalo Burger Share Personal Information?
                </p>
                ...
                <p className="mb-6 break-words">
                    We also may share personal information collected from children with vendors that perform services for Buffalo Burger. These services may include hosting our Sites, providing technical services to Buffalo Burger, fulfilling requests or administering a contest, competition, prize draw, or sweepstakes. We do not authorize such vendors to disclose the personal information we share with them other than as necessary to perform the relevant service for Buffalo Burger.
                </p>
                ...
                {/* Sec 5 */}
                <span id="sec5" className="font-bold mb-5 mr-2" >5. Your Choices</span>
                ...
                {/* Sec 6 */}
                <span id="sec6" className="font-bold mb-5 mr-2" >6. Access to and Correction and Deletion of Personal Information</span>

                <p className="mb-6 break-words">
                    If at any time you would like to access, correct, or delete personal information we have collected from you, please contact us at the email or postal address listed below. In certain circumstances, including when required by applicable law, we will comply with your request. Please note that we may be required by law to retain certain information. Before Buffalo Burger is able to provide you with any information or correct any inaccuracies, we may ask you to verify your identity and/or provide other details to help us respond to your request.
                </p>

                {/* Sec 7 */}
                <span id="sec7" className="font-bold mb-5 mr-2" >7. Cookies and Similar Technologies</span>

                <p className="mb-6 break-words">
                    Buffalo Burger uses cookies and other similar technologies to collect information for the purposes described in this Privacy Statement under &apos;How We Use the Information We Collect.&apos;
                </p>
                ...
                {/* Sec 8 */}
                <span id="sec8" className="font-bold mb-5 mr-2" >8. Targeted Advertising</span>
                ...
                {/* Sec 13 */}
                <span id="sec13" className="font-bold mb-5 mr-2 block" >13. How to Contact Us </span>
