export default function LastSec() {
    return <>
        <div className="w-full">
            ...
            <div className="bg-[url('https://buffalonlineorderingapp.s3.eu-west-1.amazonaws.com/static_images/footer-texture.png')] flex flex-col  !items-center lg:!items-start leading-none lg:leading-normal justify-center bg-[#ff5f00] p-4 lg:p-[60px] uppercase text-white font-normal  lg:tracking-wider  w-full h-[183px] ">
            ...
            <div className="relative  flex flex-col-reverse lg:flex-row  w-full h-[635px] lg:h-[309px] bg-[#1c1c1b] border-b border-b-gray-700 " >
                <div className="w-full">
                    <img src='https://buffalonlineorderingapp.s3-accelerate.amazonaws.com/static_images/footer-stars.png' alt="asdasd" className=" absolute top-0 lg:block w-full " />
                    ...
                    <div className="flex flex-col p-4 lg:p-[60px] w-full">
                        <div className="flex justify-center h-[362px] overflow-hidden lg:hidden relative w-full">
                            <img className="  flex h-[155%] w-full max-w-[288px]  " src='https://buffalonlineorderingapp.s3-accelerate.amazonaws.com/static_images/buffalo-app-CTA-img.png' alt="" />
                        </div>
                        ...
                        <div className="flex flex-row pt-6 gap-x-4">
                            <a target="_blank" href="https://play.google.com/store/apps/details?id=com.thebuffaloburger&pli=1">
                                ...
                                <img className=" md:w-[202px] md:h-[60px]" src="https://buffalonlineorderingapp.s3-accelerate.amazonaws.com/static_images/ctaGoogle.svg" alt="" />

                            </a>
                            <a target="_blank" href="https://apps.apple.com/us/app/buffalo-burger/id1661414221">

                                <img className=" md:w-[202px] md:h-[60px]" src="https://buffalonlineorderingapp.s3-accelerate.amazonaws.com/static_images/ctaApple.svg" alt="" />
                ...
                <div className="max-w-[300px] max-h-[485px] overflow-hidden hidden lg:block lg:absolute right-40 -top-44">
                    ...
                    <img src='https://buffalonlineorderingapp.s3-accelerate.amazonaws.com/static_images/buffalo-app-CTA-img.png' alt="" />
